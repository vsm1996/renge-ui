          ...
          <header style={{ paddingBottom: "var(--renge-space-7)", borderBottom: "1px solid var(--renge-color-border-subtle)" }}>
            ...
            <Stack gap="4">
              ...
              <Stack direction="horizontal" gap="3" style={{ flexWrap: "wrap", alignItems: "center" }}>
                ...
                <a href="https://github.com/vsm1996/renge-ui/tree/main/packages/test-utils" style={{ fontSize: "var(--renge-font-size-sm)", color: "var(--renge-color-accent)", textDecoration: "none" }}>GitHub →</a>
