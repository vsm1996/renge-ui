...
const TOKENS = {
  ...
  color: [
    ...
    { key: 'color-bg-subtle',    value: 'Background subtle',  formula: 'Profile-dependent', category: 'Semantic Color' },
    { key: 'color-bg-muted',     value: 'Background muted',   formula: 'Profile-dependent', category: 'Semantic Color' },
    { key: 'color-bg-inverse',   value: 'Background inverse', formula: 'Profile-dependent', category: 'Semantic Color' },
    { key: 'color-fg',           value: 'Foreground',         formula: 'Profile-dependent', category: 'Semantic Color' },
    { key: 'color-fg-subtle',    value: 'Foreground subtle',  formula: 'Profile-dependent', category: 'Semantic Color' },
    { key: 'color-fg-muted',     value: 'Foreground muted',   formula: 'Profile-dependent', category: 'Semantic Color' },
    { key: 'color-fg-inverse',   value: 'Foreground inverse', formula: 'Profile-dependent', category: 'Semantic Color' },
    { key: 'color-accent',       value: 'Accent',             formula: 'Profile-dependent', category: 'Semantic Color' },
    { key: 'color-accent-subtle', value: 'Accent subtle',     formula: 'Profile-dependent', category: 'Semantic Color' },
    { key: 'color-accent-hover', value: 'Accent hover',       formula: 'Profile-dependent', category: 'Semantic Color' },
    { key: 'color-border',       value: 'Border',             formula: 'Profile-dependent', category: 'Semantic Color' },
    { key: 'color-border-subtle',value: 'Border subtle',      formula: 'Profile-dependent', category: 'Semantic Color' },
    { key: 'color-border-focus', value: 'Border focus',       formula: 'Profile-dependent', category: 'Semantic Color' },
    { key: 'color-success',      value: 'Success',            formula: 'Profile-dependent', category: 'Semantic Color' },
    { key: 'color-success-subtle',value: 'Success subtle',    formula: 'Profile-dependent', category: 'Semantic Color' },
    { key: 'color-warning',      value: 'Warning',            formula: 'Profile-dependent', category: 'Semantic Color' },
    { key: 'color-warning-subtle',value: 'Warning subtle',    formula: 'Profile-dependent', category: 'Semantic Color' },
    { key: 'color-danger',       value: 'Danger',             formula: 'Profile-dependent', category: 'Semantic Color' },
    { key: 'color-danger-subtle',value: 'Danger subtle',      formula: 'Profile-dependent', category: 'Semantic Color' },
    { key: 'color-info',         value: 'Info',               formula: 'Profile-dependent', category: 'Semantic Color' },
    { key: 'color-info-subtle',  value: 'Info subtle',        formula: 'Profile-dependent', category: 'Semantic Color' },
  ],
  radius: [
