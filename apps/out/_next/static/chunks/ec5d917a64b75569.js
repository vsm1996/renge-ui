...
}`}},c=Object.keys(s),f={skyBlue:{l:75,c:.35,h:210},oceanBlue:{l:50,c:.5,h:190},riverBlue:{l:60,c:.45,h:200},slateBlue:{l:50,c:.4,h:210},cobaltBlue:{l:45,c:.55,h:210},indigo:{l:45,c:.25,h:280},deepIndigo:{l:30,c:.2,h:280},wildIndigo:{l:55,c:.3,h:275},twilightPurple:{l:40,c:.45,h:250},lavender:{l:75,c:.35,h:240},plumPurple:{l:45,c:.6,h:270},grassGreen:{l:70,c:.45,h:120},leafGreen:{l:75,c:.55,h:120},mossGreen:{l:50,c:.6,h:130},seaFoam:{l:80,c:.3,h:170},rainforest:{l:45,c:.6,h:130},pineGreen:{l:45,c:.65,h:140},appleGreen:{l:75,c:.45,h:120},oliveGreen:{l:55,c:.45,h:90},mossyRock:{l:45,c:.4,h:125},earthBrown:{l:45,c:.35,h:30},barkBrown:{l:40,c:.3,h:30},chocolate:{l:35,c:.5,h:30},sandBeige:{l:75,c:.15,h:40},desertTan:{l:80,c:.2,h:30},earthyOchre:{l:60,c:.5,h:40},sunsetOrange:{l:60,c:.6,h:40},leafYellow:{l:70,c:.45,h:60},wheatYellow:{l:75,c:.3,h:60},honeyYellow:{l:80,c:.35,h:50},lemonYellow:{l:85,c:.45,h:60},autumnRed:{l:60,c:.65,h:10},raspberryRed:{l:65,c:.7,h:0},firebrickRed:{l:55,c:.6,h:10},cranberryRed:{l:60,c:.55,h:0},coralPink:{l:80,c:.35,h:350},cherryBlossom:{l:85,c:.35,h:340},wildflowerPink:{l:80,c:.35,h:320},snowWhite:{l:100,c:.05,h:0},fogWhite:{l:90,c:.1,h:210},birchWhite:{l:90,c:.1,h:20},skyGrey:{l:60,c:.2,h:210},stoneGrey:{l:55,c:.2,h:10}};function u(e){return`oklch(${e.l}% ${e.c} ${e.h})`}var g={bg:u(f.snowWhite),bgSubtle:u(f.fogWhite),bgMuted:"oklch(95% 0.02 210)",bgInverse:u(f.slateBlue),fg:"oklch(20% 0.02 210)",fgSubtle:"oklch(35% 0.03 210)",fgMuted:u(f.skyGrey),fgInverse:u(f.snowWhite),border:"oklch(80% 0.02 210)",borderSubtle:"oklch(90% 0.01 210)",borderFocus:u(f.skyBlue),accent:u(f.skyBlue),accentHover:u(f.riverBlue),accentSubtle:"oklch(92% 0.08 210)",success:u(f.grassGreen),successSubtle:"oklch(92% 0.08 120)",warning:u(f.sunsetOrange),warningSubtle:"oklch(92% 0.08 40)",danger:u(f.cranberryRed),dangerSubtle:"oklch(92% 0.08 0)",info:u(f.riverBlue),infoSubtle:"oklch(92% 0.08 200)"},h={clear:g,earth:{bg:u(f.birchWhite),bgSubtle:u(f.sandBeige),bgMuted:"oklch(92% 0.04 30)",bgInverse:u(f.earthBrown),fg:"oklch(20% 0.03 30)",fgSubtle:"oklch(35% 0.04 30)",fgMuted:u(f.stoneGrey),fgInverse:u(f.birchWhite),border:"oklch(78% 0.04 30)",borderSubtle:"oklch(88% 0.02 30)",borderFocus:u(f.earthyOchre),accent:u(f.earthyOchre),accentHover:u(f.earthBrown),accentSubtle:"oklch(90% 0.08 40)",success:u(f.mossGreen),successSubtle:"oklch(90% 0.08 130)",warning:u(f.sunsetOrange),warningSubtle:"oklch(90% 0.08 40)",danger:u(f.autumnRed),dangerSubtle:"oklch(90% 0.08 10)",info:u(f.slateBlue),infoSubtle:"oklch(90% 0.08 210)"},twilight:{bg:u(f.deepIndigo),bgSubtle:"oklch(25% 0.15 270)",bgMuted:"oklch(22% 0.10 270)",bgInverse:u(f.fogWhite),fg:"oklch(92% 0.03 250)",fgSubtle:"oklch(78% 0.04 250)",fgMuted:"oklch(55% 0.08 260)",fgInverse:u(f.deepIndigo),border:"oklch(35% 0.08 270)",borderSubtle:"oklch(28% 0.06 270)",borderFocus:u(f.lavender),accent:u(f.lavender),accentHover:u(f.skyBlue),accentSubtle:"oklch(30% 0.12 250)",success:u(f.seaFoam),successSubtle:"oklch(28% 0.10 170)",warning:u(f.honeyYellow),warningSubtle:"oklch(28% 0.10 50)",danger:u(f.coralPink),dangerSubtle:"oklch(28% 0.10 350)",info:u(f.skyBlue),infoSubtle:"oklch(28% 0.10 210)"}};function d(e){let r={};for(let[t,a]of Object.entries(e)){let e=t.replace(/([A-Z])/g,"-$1").toLowerCase();r[`--renge-color-${e}`]=a}return r}var m={baseUnit:4,typeBase:16,scaleRatio:a,profile:"clear",variance:0,varianceSeed:"renge",includeReset:!1,selector:":root"};function p(e={}){let r={...m,...e},{baseUnit:t,typeBase:n,scaleRatio:c,profile:g,variance:b,varianceSeed:y,selector:k,includeReset:v}=r,x=b>0?function(e){let r=0;for(let t=0;t<e.length;t++){let a=e.charCodeAt(t);r=(r<<5)-r+a,r&=r}return function(){return r=Math.imul((r=Math.imul(r^r>>>16,0x85ebca6b))^r>>>13,0xc2b2ae35),((r^=r>>>16)>>>0)/0x100000000}}(y):void 0,S=function(e,r=0,t){let a={0:"0px"};return o.forEach((n,o)=>{let i=n*e;r>0&&t&&(i=l(i,r,t)),a[String(o+1)]=`${i}px`}),a}(t,b,x),w=function(e,r=a){let t={};for(let a of i){let n=e*Math.pow(r,a.exp);t[a.key]={fontSize:`${n}px`,lineHeight:a.lh}}return t}(n,c),B=function(e=0,r){let t={0:"0ms"};return o.slice(0,10).forEach((a,n)=>{let o=100*a;e>0&&r&&(o=l(o,e,r)),t[String(n+1)]=`${o}ms`}),t}(b,x),O=function(e,r=0,t){let a={none:"0px",full:"9999px"};return o.slice(0,5).forEach((n,o)=>{let i=n*e;r>0&&t&&(i=l(i,r,t)),a[String(o+1)]=`${i}px`}),a}(t,b,x),$=function(){let e={};for(let[r,t]of Object.entries(f)){let a=r.replace(/([A-Z])/g,"-$1").toLowerCase();e[`--renge-palette-${a}`]=u(t)}return e}(),j=d(h[g]),I={};for(let[e,r]of Object.entries(S))I[`--renge-space-${e}`]=r;for(let[e,{fontSize:r,lineHeight:t}]of Object.entries(w))I[`--renge-font-size-${e}`]=r,I[`--renge-line-height-${e}`]=t;for(let[e,r]of Object.entries(B))I[`--renge-duration-${e}`]=r;for(let[e,r]of Object.entries({linear:"linear","ease-out":"cubic-bezier(0.22, 1, 0.36, 1)","ease-in":"cubic-bezier(0.55, 0.055, 0.675, 0.19)","ease-in-out":"cubic-bezier(0.65, 0, 0.35, 1)",spring:"cubic-bezier(0.175, 0.885, 0.32, 1.275)"}))I[`--renge-easing-${e}`]=r;for(let[e,r]of Object.entries(O))I[`--renge-radius-${e}`]=r;for(let[e,r]of Object.entries($))I[e]=r;for(let[e,r]of Object.entries(j))I[e]=r;for(let[e,r]of Object.entries(function(){let e={};for(let[r,t]of Object.entries(s))e[`--renge-animation-${r}`]=t.value;return e}()))I[e]=r;let P=function(e,r,t,a){let n=[];for(let{prefix:a,comment:o}of(t&&n.push(`*, *::before, *::after {
