...
const BUDGETS = {
  '@renge-ui/tokens': { maxSize: 50, description: 'Token definitions and CSS variables' },
  '@renge-ui/react': { maxSize: 150, description: 'React components' },
  '@renge-ui/tailwind': { maxSize: 100, description: 'Tailwind CSS plugin' },
};
